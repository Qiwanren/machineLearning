...
## , 'fj_arpu'
params = ['prov_id', 'user_id', 'product_id', 'area_id', 'device_number', 'cust_sex', 'cert_age','brand', 'total_fee',
          'jf_flux', 'ct_voice_fee', 'total_flux', 'total_times', 'total_nums', 'in_cnt', 'out_cnt',
          'in_dura', 'out_dura','app_visit_cnt','app_visit_dura','app_up_flow','app_down_flow','app_total_flow','app_active_days', 'lianxi_user', 'one_city_flag', 'is_limit_speed', 'flag']
...
x_featur_params = ['cert_age', 'total_fee', 'jf_flux', 'ct_voice_fee', 'total_flux',
...
x_featur_params1 = ['cert_age', 'total_fee','total_flux',
                   'total_times', 'in_cnt', 'out_cnt', 'in_dura', 'out_dura','app_visit_cnt','app_visit_dura','app_up_flow','app_down_flow','app_active_days']
